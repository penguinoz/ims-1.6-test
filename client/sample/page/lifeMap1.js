var templateName = 'lifeMap1';

Template[templateName].onRendered(function(){
  /*	An array to store all the data */
var items = [];
var colourText = ['#FF0000', '#FF5E00', '#FFBB00', '#FFE400', '#ABF200', '#1DDB16', '#00D8FF', '#0054FF'];
var colourBackground = ['#FF0000', '#FF5E00', '#FFBB00', '#FFE400', '#ABF200', '#1DDB16', '#00D8FF', '#0054FF'];
var colourBorder = ['#FF0000', '#FF5E00', '#FFBB00', '#FFE400', '#ABF200', '#1DDB16', '#00D8FF', '#0054FF'];
