...
var templateName = "customerWriteFaq";
var instance;
var imageListTemp;
var removeImageList;
var _id; // imContent의 글ID
var targetId;
var userId;
var imageDataArray;
var imgOrigin;
...
Template[templateName].onRendered(function(){
  ...
  if(this.data){
    $('#qestionDiv').children('div.froala-reactive-meteorized').froalaEditor('html.set',this.data.question);
    $('#answerDiv').children('div.froala-reactive-meteorized').froalaEditor('html.set',this.data.answer);
    $("#customerFaqtitle").val(this.data.title);
    $("#category").val(this.data.category).attr("selected", "selected");
  }
});
...
Template[templateName].events({
  "click #save": function(e, t){
    ...
    var title = $("#customerFaqtitle").val();
    var category = $("#category").val();
    var question = $('#qestionDiv').children('div.froala-reactive-meteorized').froalaEditor('html.get', true, {imagePasteProcess: true});
    var answer = $('#answerDiv').children('div.froala-reactive-meteorized').froalaEditor('html.get', true, {imagePasteProcess: true});
    ...
    if (global.utilValidation(t)) {
      setTimeout(function(){
        ...
        Meteor.call('upsertFaq', uniqId ,saveWriteQnaData , function(error, result) {
          if (error) {
