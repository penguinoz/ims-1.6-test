...
Template[templateName].events({
  "click #toTab,#fromTab": function(e, t){
    ...
    instance.tab.set(e.currentTarget.id);
  },
...
function initialData(_searchTxt, _serchType, _sortBy, _tab){
  var tab = _tab;
  Meteor.call('getLikeData', Meteor.users.findOne({_id: Meteor.userId()}).username, _searchTxt, _serchType, _sortBy, _tab, function(error, result){
    if(error){
