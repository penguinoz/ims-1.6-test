...
// 마이페이지 > 즐겨찾기
var templateName = 'myPageFavorite';
var instance;
...
function initialData(_searchTxt, _serchType, _sortBy, _tab){
  var tab = _tab;
  Meteor.call('getFavoriteData', Meteor.users.findOne({_id: Meteor.userId()}).username, _searchTxt, _serchType, _sortBy, _tab, function(error, result){
    if(error){
